...
_MODEL_INFO = {
    "model_detection_triatominies_float32.tflite":
        ModelSpecificInfo(
            name="Model triatominie classifier",
            version="v1",
            image_width=640,
            image_height=640,
            image_min=0,
...
class MetadataPopulatorForImageClassifier(object):
  ...
  def _create_metadata(self):
    ...
    model_meta.description = ("Identify Pernambuco Brazil "
                              "triatominies from a set of %d categories." %
                              self.model_info.num_classes)
    model_meta.version = self.model_info.version
    model_meta.author = self.model_info.author
    model_meta.license = ("lepf. Version 1.0 "
                          "https://github.com/EduardoFreit")
